      ...
      <nav className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-4 group">
            ...
            />
            <span className="text-2xl font-mono font-bold tracking-tight group-hover:opacity-70 transition-opacity duration-200">
              Studio Lepine
            </span>
          </Link>
          ...
          <div className="hidden md:flex gap-8">
            {navLinks.map(({ path, label }) => (
              ...
              >
                ...
                {isActive(path) && (
                  <motion.div
                    className="absolute -bottom-[33px] left-0 right-0 h-[2px] bg-accent-dark"
                    layoutId="activeNav"
