...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
Building Studio Lepine: How I Shipped a Portfolio Site in 2 Hours with AI
I built my entire portfolio site in about 2 hours last night. Not a template. Not a drag-and-drop Wix thing. A proper React + TypeScript site deployed to Cloudflare Pages with custom branding, multiple pages, and a logo that actually means something to me.
This isn't a humblebrag. I'm not some 10x developer who can crank out production-ready sites in an afternoon. I'm a window cleaner from Saskatchewan who "vibe codes" with AI assistance because I never formally learned to program. But that's exactly why this story matters. If I can do this, the barrier to entry for building professional web presence just got a hell of a lot lower.
Here's how it actually went down.
The Domain Saga (Or: How I Learned to Stop Worrying and Love .biz)
Before I could build anything, I needed a domain. And not just any domain. I wanted lepine.com because Lepine is my last name, and I'm the last Lepine in my bloodline. It felt important.
...
Then I found the gap in their portfolio: lepine.biz was available.
For $15/year. And I'd actually own it.
Registered it for 5 years ($76) through Cloudflare, set up iCloud+ custom domain email (cody@lepine.biz), and suddenly I had beaten a publicly-traded corporation's two-decade domain hoarding strategy for less than the cost of two months' Netflix.
Branding: Why "Studio Lepine" and Not Another Startup Name
I have a problem. I keep starting brands and killing them:
...
The "Studio" part because I have a messy workshop full of woodworking tools, window cleaning equipment, and code projects. It's not a sterile lab (though I'd love to make it look like one. I'm obsessed with NileRed and StuffMadeHere videos). It's a studio where I make things.
And here's the kicker: the initials are SL. My dad's name was Serge Lepine. He was from Sherbrooke, Quebec, and passed away a few years ago after a palliative care unit gave him five extra years when he was on his death bed. Having my company initials be his felt like the right kind of permanence.
...
The Logo: From AI Renders to Actual Design
...
They looked cool. They were completely unusable as actual logos.
The problem with AI-generated logo concepts is they're maximalist by default. Every prompt gets rendered as if it's album art or a game badge. But logos need to work at 32x32 pixels as a favicon, embroidered on a shirt, laser-cut from steel, and printed in black-and-white on a business card.
...
The whole thing took maybe 30 minutes of iteration to get right. The key was knowing when to stop adding shit.
Building the Site: Claude Code + 2 Hours
...
I fed Claude Code a detailed prompt with:
...
Content priorities (showcase digital + physical work, featured projects, contact email prominent)
...
The "I Don't Know How to Code" Thing
I need to address this because it's probably confusing: I built a React + TypeScript site but claim I don't know how to code.
Here's what I mean: I never sat down and memorized JavaScript syntax. I never took a CS course. I can't write a function from scratch without looking up the structure first.
But I understand code. I can read it, debug it, fix syntax errors, understand logic flow, and most importantly, I know what I want the code to do. I just use AI to translate my intent into actual syntax.
On October 1st (first day of my Cursor Pro billing cycle), I burned through 45 million tokens in about 12 hours building a field service management app. Two separate repos (React web app + Swift iOS app), both with Supabase backends, real-time sync working, about 40,000 lines of code generated. I was essentially running two AI agents simultaneously, having them scaffold entire features while I reviewed, tested, and iterated.
That's not "traditional" coding. But the result is the same: I'm shipping production-ready software that solves real problems for my $200k/year window cleaning business.
The leverage is insane. Pre-AI, I'd need to hire contractors for $50k-100k to build what I'm building myself in weekends. Now I just need to be good at systems thinking, problem decomposition, and knowing what to ask for.
...
The through-line isn't "I do random stuff." It's "I see problems and build solutions, whether that's in code or with my hands."
...
What's Next
The site is live. V1 is done. But there's still work to do:
Immediate:
...
The Bigger Point
I'm not writing this to flex. I'm writing it because the barrier to building professional online presence just collapsed.
You don't need to be a developer. You don't need to hire an agency for $10k. You don't need to use a shitty drag-and-drop website builder that locks you into $15/month forever.
You need:
...
If you're on the fence about building something (whether that's a portfolio site, a side project, or a full-on product), just start. Use AI to handle the stuff you don't know, learn as you go, and ship something that's yours.
I went from "I want lepine.com but it's owned by a corporation forever" to "I own lepine.biz and have a live professional site" in one night.
You can too.
    `.trim(),
